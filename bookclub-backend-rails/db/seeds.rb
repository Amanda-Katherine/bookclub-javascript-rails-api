Book.create(title: "The Count of Monte Cristo", author: "Alexandre Dumas", cover_url: "http://books.google.com/books/content?id=MVtoAwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api", preview: "Wrongfully imprisoned for 14 years, Edmond Dantès escapes to the island of Monte Cristo. What awaits him there is a fortune in gold--and a new identity with which to pursue his revenge and redemption.")
Book.create(title: "Born A Crime", author: "Trevor Noah", cover_url: "http://books.google.com/books/content?id=dAzJCwAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api", preview: "Trevor Noah grew up in South Africa with a black South African mother and a white Swiss father at a time when it was against the law for a mixed race child to exist. But Trevor did exist. In Born a crime, Trevor shares what his life was like growing up. The stories he tells in this book will make you laugh, cry and fill you with wonder and inspirations as you learn how this mischievous young boy used his quick wits and humour to get through his day-to-day life. Against all odds and with his mother's unfailing love and belief in him. Trevor overcame many obstacles to create a promising future for himself.")
Book.create(title: "Into the Wild", author: "John Krakauer", cover_url: "http://books.google.com/books/content?id=waBwNtI6rSwC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api", preview: "INTO THE WILD is based on a true story and the bestselling book by Jon Krakauer. After graduating from Emory University in 1992, top student and athlete Christopher McCandless (Hirsch) abandons his possessions, gave his entire $24,000 savings account to charity and hitchhiked to Alaska to live in the wilderness. Along the way, Christopher encounters a series of characters that shape his life.")
...
Suggestion.create(book_id: "1", book_group_id: "4", vote: "1")
...
Suggestion.create(book_id: "3", book_group_id: "3", vote: "2")

Suggestion.create(book_id: "4", book_group_id: "1", vote: "7")
Suggestion.create(book_id: "4", book_group_id: "2", vote: "1")
...
# Suggestion.create(title: "", author: "", cover_url: "", preview: "")
# Suggestion.create(title: "", author: "", cover_url: "", preview: "")
# Suggestion.create(title: "", author: "", cover_url: "", preview: "")
# Suggestion.create(title: "", author: "", cover_url: "", preview: "")