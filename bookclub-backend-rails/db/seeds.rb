...
BookGroup.create(name: "If you do not currently belong to a bookclub, select this", password: "pass", id: 0)
...
Member.create(first_name: "Megan", last_name: "Rapinoe", email: "fake_email1@fake.com", password: "pass", book_group_id: "2")
Member.create(first_name: "Sue", last_name: "Bird", email: "fake_email2@fake.com", password: "pass", book_group_id: "2")
Member.create(first_name: "Larry", last_name: "Fitzgerald", email: "fake_email3@fake.com", password: "pass", book_group_id: "1")
Member.create(first_name: "LeBron", last_name: "James", email: "fake_email14@fake.com", password: "pass", book_group_id: "4")
Member.create(first_name: "Randy", last_name: "Johnson", email: "fake_email15@fake.com", password: "pass", book_group_id: "1")
Member.create(first_name: "Jackie", last_name: "Robinson", email: "fake_email16@fake.com", password: "pass", book_group_id: "4")
Member.create(first_name: "Babe", last_name: "Ruth", email: "fake_email17@fake.com", password: "pass", book_group_id: "3")
Member.create(first_name: "Brett", last_name: "Favre", email: "fake_email18@fake.com", password: "pass", book_group_id: "1")
Member.create(first_name: "Wes", last_name: "Welker", email: "fake_email19@fake.com", password: "pass", book_group_id: "3")
Member.create(first_name: "Joe", last_name: "Montana", email: "fake_email10@fake.com", password: "pass", book_group_id: "4")
Member.create(first_name: "Al", last_name: "Horford", email: "fake_email11@fake.com", password: "pass", book_group_id: "2")
Member.create(first_name: "Ryan", last_name: "Fitzpatrick", email: "fake_email12@fake.com", password: "pass", book_group_id: "2")
Member.create(first_name: "Gardner", last_name: "Minshew", email: "fake_email13@fake.com", password: "pass", book_group_id: "3")
