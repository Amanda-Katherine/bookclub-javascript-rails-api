...
BookGroup.create(name: "The Bookworms")
BookGroup.create(name: "The Wild Readers")
BookGroup.create(name: "All Booked")
BookGroup.create(name: "Booked Ends")

Member.create(first_name: "Megan", last_name: "Rapinoe", password: "pass")
Member.create(first_name: "Sue", last_name: "Bird", password: "pass")
Member.create(first_name: "Larry", last_name: "Fitzgerald", password: "pass")
Member.create(first_name: "LeBron", last_name: "James", password: "pass")
Member.create(first_name: "Randy", last_name: "Johnson", password: "pass")
Member.create(first_name: "Jackie", last_name: "Robinson", password: "pass")
Member.create(first_name: "Babe", last_name: "Ruth", password: "pass")
Member.create(first_name: "Brett", last_name: "Favre", password: "pass")
Member.create(first_name: "Wes", last_name: "Welker", password: "pass")
Member.create(first_name: "Joe", last_name: "Montana", password: "pass")
Member.create(first_name: "Al", last_name: "Horford", password: "pass")
Member.create(first_name: "Ryan", last_name: "Fitzpatrick", password: "pass")
